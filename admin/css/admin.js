// Credenciais (MUDE A SENHA!)
const ADMIN_USER = 'admin';
const ADMIN_PASS = 'carol2025';
...
async function carregarAgendamentos() {
    ...
    try {
        ...
        tabelaBody.innerHTML = '<tr><td colspan="7" style="text-align: center; color: red;">Erro ao carregar agendamentos</td></tr>';
    } finally {
...
function renderizarTabela() {
    ...
    if (agendamentos.length === 0) {
        tbody.innerHTML = '<tr><td colspan="7" style="text-align: center; color: #999;">Nenhum agendamento encontrado</td></tr>';
        return;
    }
    ...
    tbody.innerHTML = agendamentos.map(ag => {
        ...
        return `
            <tr>
                ...
                <td>
                    <button class="btn btn-info btn-small" onclick="verDetalhes('${ag._id}')">👁️</button>
